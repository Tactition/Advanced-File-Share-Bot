...
async def start(client, message):
    ...
    if len(message.command) != 2:
        ...
        [
            ...
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/Self_Improvement_AudioBooks')
        ],[
    ...
    try:
        ...
        return await message.reply_text("Please get the link from @Self_Improvement_AudioBooks to access the files From Torrent Servers.")
    ...
    try:
        ...
        await client.send_message(LOG_CHANNEL, f"Boss User {message.from_user.mention} requested file {title} with Id {msg.id} via deep link.")
        if msg.media:
            # Capture the original caption if any.
            orig_caption = ""
            if msg.caption:
